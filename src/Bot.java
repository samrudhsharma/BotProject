// Developed by: Samrudh Sharma. 26-05-2018.
// A bot to autonomously fill out a visa appointment form, scheduled to run every two minutes.
// Developed using Selenium WebDriver (ChromDriver Extension) and Java.
...
public void fillForm(WebDriver driver) {
 ...
 public void run() { // Function runs every MINUTES minutes.
  ...
  String innerT = driver.findElement(By.xpath("//*[@id=\"valErrMsg\"]")).getText();
  if(innerT.contains("The fields highlighted in red must be completed")) {
	String errorMessage = driver.findElement(By.xpath("//*[@id=\"dvMsgs\"]")).getText();
	System.out.println(errorMessage);
	System.out.println("Please check the details and run again.");
	timer.cancel();
	timer.purge();
  }
  else{
